...
class TinyMCEFieldType extends BaseFieldType
{
	...
	public function getSettingsHtml()
	{
		...
		$configPath = craft()->path->getConfigPath() . 'tinymce/';
		...
		return craft()->templates->render('tinymce/_fieldtype/settings', [
	...
	{
		$configUrl = UrlHelper::getActionUrl('TinyMCE/config/' . $this->getSettings()->configFile);
		...
		return craft()->templates->render('tinymce/_fieldtype/input', $settings);
	}
